                ...
                <div class="col-lg-8">
                    <main class="main-detail">
                        <div class="row pb-4">
                            ...
                            @empty
                            <div class="col-md-12 mt-5 mt-md-4 text-center">
                                <div class="blog-item p-2 py-5">
                                    <p class="text-muted fs-6 mt-3 mb-3">محتوایی برای این دسته بندی وجود ندارد.</p>
                                    <a href="{{route('blog')}}" class="text-primary">رفتن به صفحه بلاگ</a>
                                </div>
                            </div>
                            @endforelse
                                ...
                                @foreach($category as $item)
                                    ...
                                    <div class="sidebar-item align-items-center">
                                        <div class="sidebar-item-text pt-4 align-items-center  d-flex">
                                            <small class="px-2 fs-6 text-muted"><a href="{{ route('search', $item->id) }}" class="text-muted">{{$item->name}}</a></small>
                                        </div>
                                    </div>
