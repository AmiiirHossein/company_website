        ...
        <div class="row">
            <div class="col-md-6  mt-5 mt-md-0">
                <div class="about-content">
                    ...
                    <h1 class="fs-1 fw-bold py-2 text-dark">{{$about->subtitle}}</h1>
            ...
            <div class="col-md-6 mt-5 mt-md-0">
                <div class="about-img w-100">
                    <img src="{{asset('/back/images/about/'.$about->image)}}" class="about-image" alt="{{$about->title}}">
                    <div class="counter-wrap d-flex py-3 px-3 align-items-center">
                        ...
                        <div class="text d-flex flex-column px-3">
                            <span class="number text-primary fw-bold fs-3">{{$about->experience_title}}</span>
