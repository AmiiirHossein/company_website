            ...
            <div class="row min-vh-100 align-items-center justify-content-center text-center">
                <div class="col-lg-9 ">
                    <div class="hero-wrap-content position-relative">
                        ...
                        <h1 class="fs-1 text-white fw-bold lh-5 py-3 my-5 hero-description">{{$hero->description}}</h1>
                        <p class="mt-5">
                            <a href="{{$hero->about}}" class="btn btn-dark w-25 py-3">تماس با ما</a>
                            <a href="{{$hero->question}}" class="btn btn-primary w-25 text-dark py-3">سوالات متداول</a>
                        </p>
                    </div>
                </div>
            </div>
